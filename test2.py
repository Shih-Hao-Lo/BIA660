...
clf3 = svm.LinearSVC()
clf4 = MLPClassifier()
clf5 = SGDClassifier(loss="hinge", penalty="l2", max_iter=15)
...
clf = [clf1, clf2, clf3, clf4, clf5, clf7]
arr = ['MultinomialNB','SVC','LinearSVC','MLPClassifier','SGDClassifier','XGBClassifier']
...
for x in range(len(rev_test)):
    vote = {'cse':0, 'siggraph':0, 'sigir':0, 'www':0, 'chi':0, 'cikm':0, 'kdd':0}
